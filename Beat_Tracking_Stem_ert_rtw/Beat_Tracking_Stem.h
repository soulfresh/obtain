...
typedef struct {
  ...
  real_T CumulativeScoreMemory_PreviousI[2048]; /* '<Root>/Cumulative Score
                                                   Memory' */
  real_T BeatsLocationMemory_PreviousInp[2048]; /* '<Root>/Beats Location
                                                   Memory' */
  ...
  struct {
    void *LoggedData;
  } BeatPeriodOverallToWorkspace_PW; /* '<Root>/Beat Period Overall To
                                        Workspace' */
